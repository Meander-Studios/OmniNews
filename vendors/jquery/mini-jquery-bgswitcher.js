var bgSlider = function(params) {
    ...
    for (var image in images) {
       ...
       if(typeof params.gradient === "undefined"){
            $('#img' + image).css('background-image', 'url("' + images[image] + '")');
       }else{
            $('#img' + image).css('background-image', '' + params.gradient + ',url("' + images[image] + '")');
       }
       if(params.vignette === true){
            $('#img' + image).css('box-shadow', 'inset 0 0 5em 1em black');
       }
       if(typeof params.backgroundcss != "undefined"){
            $('#img' + image).css('background', params.backgroundcss + ',url("' + images[image] + '")');
